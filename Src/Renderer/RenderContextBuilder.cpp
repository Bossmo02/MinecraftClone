#include "RenderContextBuilder.h"



RenderContextBuilder& RenderContextBuilder::get()
{
    static RenderContextBuilder r;
    return r;
}

void RenderContextBuilder::parseBlockDataToRenderContext(RenderContext* con, std::vector<BlockMeshData> blockData, std::vector<int> numOfFacesForBlocks)
{
    int indicesOffset = 0;
...
void RenderContextBuilder::sendDataToGPU(RenderContext* con)
{
